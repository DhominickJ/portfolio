...
export default function About() {
    return(`
        <section id="intro" class="min-h-screen flex justify-center items-center flex-col text-center fade-in p-4">
            ...
            <h2 class="text-xl md:text-3xl text-blue-600 dark:text-blue-300 mb-6">Web Developer & Designer</h2>
            <p class="text-base md:text-lg mb-8 leading-relaxed text-blue-800 dark:text-blue-300">
            I am passionate about tech especially with hardware on the side. I have a homelab at home running a LLM's system off the network. My favorite hobby is monitoring my sibling's internet history. I am always the guy that people go to whenever they have problems with their computers. 
            </p>
